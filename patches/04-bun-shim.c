/*
 * patch 04: LD_PRELOAD shim
 *
 * Redirects EACCES-prone open/stat/access calls on paths under
 * /data/data/com.termux/files/home/ to be relative to a file descriptor
 * held on that directory, working around glibc/termux permission issues.
 */
#include <stdarg.h>
#include <fcntl.h>
